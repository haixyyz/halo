 ...
 *   例如：org.xujin.halo.sales.service.test.CustomerServiceTest.testCheckConflict()
...
public class TestsContainer implements ApplicationContextAware{
    ...
    private static void execute(String input) throws Exception{
        ...
        if (WELCOME_INPUT.equals(input)){
            ...
            System.out.println("**** 例如：org.xujin.halo.sales.service.test.CustomerServiceTest.testCheckConflict()");
            System.out.println("**** 2.测试整个测试类，请在控制台输入类全称");
            System.out.println("**** 例如：org.xujin.halo.sales.service.test.CustomerServiceTest");
